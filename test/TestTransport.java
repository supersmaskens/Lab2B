...
public class TestTransport {
    ...
    public void cantMoveWhileTransported() {
        Workshop<Volvo240> ws = new Workshop<>(0,0,0, 32);
    ...
    public void unloadableTest(){
        Workshop<PassengerCar> ws = new Workshop<>(0,0,0,32);
    ...
    public void cantUnload() {
        Workshop<PassengerCar> ferry = new Workshop<>(0,0,0 ,32);
        Volvo240 car = new Volvo240();
        ferry.loadableOn();
        ferry.load(car);
        ferry.loadableOff();
